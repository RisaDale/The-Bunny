...
public class MotionEventCompat {
    ...
    interface MotionEventVersionImpl {
        ...
        int getPointerCount(MotionEvent event, int pointerIndex);
    }
    ...
    static class BaseMotionEventVersionImpl implements MotionEventVersionImpl {
        ...
        @Override
        public int getPointerCount(MotionEvent event, int pointerIndex) {
            return 0;
        }
    }
    ...
    /**
     cncnc* Synonym for {@link MotionEvent#ACTION_POINTER_INDEX_MASK}.
     */
